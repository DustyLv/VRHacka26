...
using ithappy.City_Characters.CharacterCustomizationTool.Editor.Randomizer;
using ithappy.City_Characters.CharacterCustomizationTool.FaceManagement;
...
namespace ithappy.City_Characters.CharacterCustomizationTool.Editor
{
    public class CharacterCustomizationWindow : EditorWindow
    {
        ...
        [MenuItem("Tools/ithappy/City_Characters/Character Customization", priority = 0)]
